...
const messageTemplate = document.querySelector('#message-template')! as HTMLScriptElement
const locationTemplate = document.querySelector('#location-message-template')! as HTMLScriptElement
const sidebarTemplate = document.querySelector('#sidebar-template')! as HTMLScriptElement
